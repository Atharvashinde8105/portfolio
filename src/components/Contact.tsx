      ...
      <div className="container px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-on-scroll">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Ready to discuss cybersecurity challenges, opportunities, or collaboration? 
          ...
          <div className="animate-on-scroll">
            <div className="bg-card rounded-2xl p-8 border border-border">
              ...
              <p className="text-muted-foreground mb-8 leading-relaxed">
                Whether you're looking for a cybersecurity professional, have a project in mind, 
                or just want to discuss the latest in cybersecurity, I'm always open to meaningful conversations.
              </p>
                ...
                {contactInfo.map((info, index) => {
                  ...
                  return (
                    <div key={info.label} className="flex items-center gap-4 group">
                      <div className={`p-3 rounded-xl bg-secondary ${info.color} group-hover:scale-110 transition-transform`}>
              ...
              <div className="mt-8 p-4 bg-primary/10 rounded-xl border border-primary/20">
                ...
                <p className="text-sm text-muted-foreground">
                  Open to full-time opportunities, internships, and freelance projects in cybersecurity.
                </p>
              </div>
            </div>
          </div>
